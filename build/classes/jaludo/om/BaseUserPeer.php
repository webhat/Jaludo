...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'Username', 'Password', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'username', 'password', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::EMAIL, UserPeer::USERNAME, UserPeer::PASSWORD, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'EMAIL', 'USERNAME', 'PASSWORD', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'email', 'username', 'password', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'Username' => 2, 'Password' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'username' => 2, 'password' => 3, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::EMAIL => 1, UserPeer::USERNAME => 2, UserPeer::PASSWORD => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'EMAIL' => 1, 'USERNAME' => 2, 'PASSWORD' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'email' => 1, 'username' => 2, 'password' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
